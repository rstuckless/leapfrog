...
class ExpertisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expertise" do
    assert_difference('Expertise.count') do
      post expertises_url, params: { expertise: { expert_id: @expertise.expert_id, level: @expertise.level, skill_id: @expertise.skill_id } }
    end
  ...
  test "should update expertise" do
    patch expertise_url(@expertise), params: { expertise: { expert_id: @expertise.expert_id, level: @expertise.level, skill_id: @expertise.skill_id } }
