...
class ExpertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expert" do
    assert_difference('Expert.count') do
      post experts_url, params: { expert: { email: @expert.email, name: @expert.name, picture_url: @expert.picture_url } }
    end
  ...
  test "should update expert" do
    patch expert_url(@expert), params: { expert: { email: @expert.email, name: @expert.name, picture_url: @expert.picture_url } }
